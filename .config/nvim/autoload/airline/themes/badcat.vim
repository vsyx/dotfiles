...
let s:guiRed         = "#ff5f5f"
let s:guiGreen       = "#d7005f"
let s:guiBlue        = "#d7005f"
let s:guiOrange      = "#d7005f"
...
let s:CP1 = [ s:guiWhite , s:guiBlack, s:ctermWhite , s:ctermGray  ]
let s:CP2 = [ s:guiWhite , s:guiBlack, s:ctermWhite , s:ctermGray  ]
